/**
 * Julkar — shared helpers for the transcription dashboard.
 *
 * Owns:
...
export const NOTES_KEY = (sessionId: string) => `julkar_notes_${sessionId}`;
export const HIGHLIGHTS_KEY = (sessionId: string) => `julkar_highlights_${sessionId}`;
export const EVAL_KEY = (sessionId: string) => `julkar_eval_${sessionId}`;
